...
infile = open("HP_Moonshot/wordcount512mb.log", "r")
...
plt2.plot(progress_t0[0],write_per_time_t0[0],'bo')
plt2.plot(progress_t0[1],write_per_time_t0[1],'ro')
plt2.plot(progress_t0[2],write_per_time_t0[2],'go')
plt2.plot(progress_t0[3],write_per_time_t0[3],'yo')
plt2.plot(progress_t0[4],write_per_time_t0[4],'mo')
plt2.plot(progress_t0[5],write_per_time_t0[5],'ko')
plt2.plot(progress_t0[6],write_per_time_t0[6],'co')
plt2.plot(progress_t0[7],write_per_time_t0[7],'rx')
plt2.plot(progress_t0[8],write_per_time_t0[8],'bo')
plt2.plot(progress_t0[9],write_per_time_t0[9],'ro')
plt2.plot(progress_t0[10],write_per_time_t0[10],'go')
plt2.plot(progress_t0[11],write_per_time_t0[11],'yo')
plt2.plot(progress_t0[12],write_per_time_t0[12],'mo')
plt2.plot(progress_t0[13],write_per_time_t0[13],'ko')
plt2.plot(progress_t0[14],write_per_time_t0[14],'co')
plt2.plot(progress_t0[15],write_per_time_t0[15],'rx')
plt2.plot(progress_t0[16],write_per_time_t0[16],'bo')
plt2.plot(progress_t0[17],write_per_time_t0[17],'ro')
plt2.plot(progress_t0[18],write_per_time_t0[18],'go')
plt2.plot(progress_t0[19],write_per_time_t0[19],'yo')
plt2.plot(progress_t0[20],write_per_time_t0[20],'mo')
