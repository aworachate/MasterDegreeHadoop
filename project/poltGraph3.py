...
infile = open("HP_Moonshot/KMean_new_app_r3.log", "r")
#infile = open("pi/bay1.log", "r")
progress_t0 = [[]for x in xrange(31)]
cpu_per_time_t0 = [[]for x in xrange(31)]
write_per_time_t0 = [[]for x in xrange(31)]
finishedSize_t0 =[[]for x in xrange(31)]
write_per_done_t0 = [[]for x in xrange(31)]
task_time_t0 = [[]for x in xrange(31)]
fin_map_time_t0 = [[]for x in xrange(31)]
# progress_t1 = []
# cpu_per_time_t1 = []
# write_per_time_t1 = []
# write_per_done_t1 = []
